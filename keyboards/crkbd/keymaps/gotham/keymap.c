...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         KC_LGUI, LOW_ESC, LOW_SPC,     RAI_ENT, RAISE, KC_RALT
                                      //|--------------------------|  |--------------------------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______,    TALL,     WIDE,    FULL, CMD_SPC,   CMD_9,                      KC_LEFT, KC_DOWN,  KC_UP,   KC_RIGHT, KC_NO, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______,  _______,  KC_NO,   KC_NO,    KC_NO,   KC_NO,                      KC_VOLU,  KC_VOLD,   KC_NO,   KC_NO, XXXXXXX, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         _______, _______, _______,    _______, MO(ADJUST), _______
                                      //|--------------------------|  |--------------------------|
  ),
